#ifndef RM_SENTRY_2024_SET_VAL_ONCE_NODE_
#define RM_SENTRY_2024_SET_VAL_ONCE_NODE_
...
namespace BehaviorTree{
    class SetValOnceNode:public BT::SyncActionNode{
        public:
        ...
        SetValOnceNode(const std::string&name, const BT::NodeConfig& config);
