...
namespace BehaviorTree{
    ...
    BT::NodeStatus TimeCompuInterval::tick(){
        RCLCPP_INFO(rclcpp::get_logger("time_compu_node"),"I'm trying ticked");
        ...
        if(!getInput<double>("time_limit_max",time_limit_max)) return BT::NodeStatus::FAILURE;
        if(!getInput<double>("time_limit_min",time_limit_min)) return BT::NodeStatus::FAILURE;
